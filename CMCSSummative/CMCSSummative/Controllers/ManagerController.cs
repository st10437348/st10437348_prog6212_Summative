...
namespace CMCSPart2.Controllers
{
    public class ManagerController : Controller
    {
        ...
        public ManagerController(AppDbContext db, ClaimValidationService validationService)
        {
        ...
        public async Task<IActionResult> Claims()
        {
            ...
            foreach (var c in claims)
            {
                ...
                list.Add(new Claim
                {
                    ...
                    Notes = c.Notes,
                    Documents = await _db.Documents.Where(d => d.ClaimId == c.ClaimId).ToListAsync(),
                    Approvals = approvals
                });
            }
